...
@interface XPBActionTableViewCell()
...
@implementation XPBActionTableViewCell
...
-(void)setDataModel:(XPBActionDataModel *)dataModel{
    ...
    [_statueBtn setTitle:dataModel.act_type_name forState:UIControlStateNormal];
